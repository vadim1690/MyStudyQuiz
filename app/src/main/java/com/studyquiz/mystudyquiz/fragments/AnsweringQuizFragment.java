...
public class AnsweringQuizFragment extends Fragment {
    ...
    private void initializeAds() {
        ...
        InterstitialAd.load(requireContext(), BuildConfig.ADMOB_INTERSTITIAL_AD_ID_ANSWERED_QUIZ, adRequest,
    ...
    private void helpClicked() {
        AppUtils.showAlertDialog(requireActivity(),"Answer the question by clicking the answer you think is correct or you can press skip if you don`t know the answer.");
    }
