...
import com.studyquiz.mystudyquiz.databinding.AddAnswersToQuestionFragmentBinding;
...
public class AddAnswersToQuestionFragment extends Fragment {
    ...
    private void initializeAds() {
        ...
        InterstitialAd.load(requireContext(), BuildConfig.ADMOB_INTERSTITIAL_AD_ID_QUESTION_ADD, adRequest,
